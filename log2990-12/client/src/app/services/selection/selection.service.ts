...
export class SelectionService extends ActiveToolService {
  ...
  leftClick(event: MouseEvent): void {
    ...
    if (selectedElement.parentNode) {
      if (selectedElement.parentNode.parentNode) {
        if (selectedElement.parentNode.parentNode.nodeName === SvgTypes.G) {
          selectedElement = selectedElement.parentNode as SVGGraphicsElement;
        }
      }
    }
  ...
  updateMagnetismState(state: boolean): void {
    this.isMagnetised = state;
  }
